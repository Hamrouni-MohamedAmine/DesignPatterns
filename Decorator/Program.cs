...
var messageDatabaseDecorator = new MessageDatabseDecorator(onPremiseMailService);
messageDatabaseDecorator.SendMail($@"Hi there via {nameof(MessageDatabseDecorator)} wrapper, message 1 .");
messageDatabaseDecorator.SendMail($@"Hi there via {nameof(MessageDatabseDecorator)} wrapper, message 2 .");
