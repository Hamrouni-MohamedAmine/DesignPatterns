namespace Decorator
{
    ...
    /// ConcreteDecorator2
    /// </summary>
    public class MessageDatabseDecorator : MailServiceDecoratorBase
    {
        /// <summary>
        /// A list of sent messages , as fake databse  - test purpose only
        /// </summary>
        public List<string> SentMessages { get; private set; } = new List<string>();
        public MessageDatabseDecorator(IMailService mailService) 
            : base(mailService)
        {
        }
