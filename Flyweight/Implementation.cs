namespace Flyweight
{
    ...
    public class CharacterA : ICharacter
    {
        ...
        private string _fontFamily = string.Empty; // extrinsic state can be change
        private int _fontSize;// extrinsic state can be change
    ...
    {
        private char _actualCharacter = 'b'; // intrinsic state
        private string _fontFamily = string.Empty; // extrinsic state can be change
        private int _fontSize;// extrinsic state can be change
    ...
    public class CharacterFactory
    {
        ...
        public ICharacter CreatePraragraph(List<ICharacter> characters, int location)
        {
