namespace Adapter
{
    ...
    {
        //you can use dependency injection here to inject the ExternalSystem object
        public ExternalSystem External { get; private set; } = new();
        public City GetCity()
        {
            // call the external system
            var cityFromExternalSystem = External.GetCity();
